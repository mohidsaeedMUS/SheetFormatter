...
#fix this make sure strip works
for words in subset:
    words.strip()
#potentially set sheet name
df = pd.concat(pd.read_excel('/Users/amark/Documents/GitHub/SheetFormatter/Test Series 3/Test_both_copy.xlsx', sheet_name=None),ignore_index=True)
...
wb = openpyxl.load_workbook("/Users/amark/Documents/GitHub/SheetFormatter/Test Series 3/Test_both_copy.xlsx")
ws=wb.active
...
wb.save("/Users/amark/Documents/GitHub/SheetFormatter/Test Series 3/Test_both_copy.xlsx")
